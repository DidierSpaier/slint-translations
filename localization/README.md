...
To generate a PO file <name>.pot from <name>.adoc (used in Slint for HandBook.adoc and homepage.adoc) the following command can be used, where name=HandBook or name=homepage:

po4a-updatepo -f asciidoc -m sources/${name}.adoc -M UTF-8 -p POT/${name}.pot
