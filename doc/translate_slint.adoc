...
To know what the Slint project is about, please read first if not yet done in this https://slint.fr/doc/HandBook.html#_introduction_to_slint[introduction to Slint] at least link:../en/HandBook.html#_about_slint[About Slint] and link:../en/HandBook.html#_support_and_contributions[Support and contributions]
...
* HandBook.adoc is in asciidoc format. It is converted to html using https://asciidoctor.org/[Asciidoctor] to provide the link:../en/HandBook.html[Slint HandBook] +
* All other files are PO (Portable Objects) files, extracted from shell scripts and converted back and forth using the *gettext* and *po4a* software. To know more read link:/doc/slint-translations/blob/main/doc/internationalization_and_localization_of_shell_scripts.adoc[Internationalization and localization of shell scripts]
